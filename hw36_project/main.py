...
Мета:
Реалізувати консольну програму "Менеджер Завдань", яка дозволить створювати, редагувати,
видаляти та переглядати список завдань. Програма має підтримувати посторінковий вивід завдань,
обробку винятків та базовий пошук.

Основні компоненти програми
Класи
Task (Завдання)

Описує окреме завдання.
Поля:
...
Керує колекцією завдань. Наслідується від UserDict.
Поля:
...
Обробляє винятки в методах і повертає відповідні повідомлення.
Методи:
